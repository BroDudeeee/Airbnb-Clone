  ...
  return (
    <div className="relative h-64 md:h-80 lg:h-96">
      ...
      <div className="absolute top-1/2 w-full text-center text-white">
        ...
        <button className="font-bold text-blue-900 bg-white py-3 px-6 rounded-full shadow-md hover:shadow-xl active:scale-90 transition duration-150 mt-2">I'm flexible</button>
      </div>
    </div>
  )
}
