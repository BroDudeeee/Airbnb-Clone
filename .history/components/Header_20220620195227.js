...
const Header = () => {
  return (
    <header className='grid grid-cols-3 shadow-md bg-white sticky top-0 z-50 items-center py-1 px-2 space-x-10'> 
      {/* Left */}
      ...
      <div className='flex border rounded-full py-1 space-x-2 items-center px-2 hover:ring-1 ring-gray-400'>
        <input 
          type="text" 
          placeholder='Search'
          className='flex-shrink md:flex-grow bg-transparent placeholder-gray-400 text-gray-600'
        />
        <SearchIcon 
