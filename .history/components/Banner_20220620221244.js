  ...
  return (
    <div className="relative h-56 md:h-64 lg:h-80 xl:h-96">
      ...
      <div className="absolute top-1/2 w-full text-center text-white">
        ...
        <button className="text-blue-900 bg-white py-2 px-4 rounded-full shadow-md hover:shadow-xl active:scale-90 transition duration-200 mt-2">I'm flexible</button>
      </div>
    </div>
  )
}
